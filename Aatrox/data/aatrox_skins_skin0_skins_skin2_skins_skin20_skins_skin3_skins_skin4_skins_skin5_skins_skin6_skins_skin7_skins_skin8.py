    ...
    "Characters/Aatrox/Skins/Skin0/Particles/Aatrox_Base_Recall_Ground" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Aatrox/Skins/Base/Particles/Aatrox_Base_Q_ground_crack_01.dds"
            }
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                ...
                texture: string = "ASSETS/Characters/Aatrox/Skins/Base/Particles/Aatrox_Base_Q_Smoke_01.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
                textureMult: pointer = VfxTextureMultDefinitionData {
                    textureMult: string = "ASSETS/Characters/Aatrox/Skins/Base/Particles/Aatrox_Base_Q_smoke_mult.dds"
                    texDivMult: vec2 = { 2, 2 }
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Aatrox/Skins/Base/Particles/Aatrox_Base_W_Ground_Clump.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
            }
            VfxEmitterDefinitionData {
            ...
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/Characters/Aatrox/Skins/Base/Particles/Aatrox_Base_R_Red_Overlay.dds"
                numFrames: u16 = 4
                birthUvScrollRate: embed = ValueVector2 {
